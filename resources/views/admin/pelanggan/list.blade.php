            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button class="btn btn-success passingEDIT" data-toggle="modal" data-target="#modal-edit" data-id="{{$s->id}}" id="edit"><i class="fas fa-pencil-alt"></i></button>
                        <button class="btn btn-danger passingHAPUS" data-toggle="modal" data-target="#modal-hapus" data-id="{{$s->id}}" data-kt="{{$s->nama_pelanggan}}"><i class="fas fa-trash"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('pelanggan.ubah')}}" method="POST" id="eform">
                    @csrf
                    @method('PUT')
...
<div class="modal fade" id="modal-hapus">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('pelanggan.hapus')}}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(".passingEDIT").click(function() {
        ...
        console.log(ids)
        $.get('pelanggan/' + ids + '/edit', function(data) {
            $("#idkt").val(data.id);
